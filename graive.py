...
class GraiveAI:
    ...
    def __init__(
        ...
        print("[1/6] Initializing Reflection System...")
        ...
        print("\n[6/8] Initializing Browser Automation...")
        self.browser = None
        ...
        print("\n[7/8] Initializing Quality Review System...")
        try:
        ...
        print("\n[8/9] Initializing Document Formatter...")
        try:
        ...
        print("\n[9/10] Initializing Image Generator...")
        try:
        ...
        print("\n[10/11] Initializing Autonomous Task Executor...")
        try:
        ...
        print("\n[11/12] Initializing CLI File Operations...")
        try:
        ...
        print("\n[12/13] Initializing Strategic Document Planner...")
        try:
        ...
        print("\n[13/13] Initializing Request Reasoning System...")
        try:
    ...
    def generate_document(
        ...
        """
        Generate a complete document with PhD-level review and professional formatting.
        
        Args:
            topic: Document topic
            word_count: Target word count
            include_images: Include actual images
            include_tables: Include data tables
            output_format: Output format (md, docx, pdf)
            enable_phd_review: Enable PhD-level review and revision
        ...
        try:
            ...
            print(f"{'='*70}")
            print(f"Target: {word_count} words | Format: {output_format.upper()}")
            ...
            print(f"           Estimated time: 15-30 seconds")
            print(f"           Status: Sending request...")
            ...
            review_report: Optional[Dict[str, Any]] = None  # Initialize variable
            if enable_phd_review and self.review_system:
                print(f"[Step 2/6] 🎓 PhD-Level Quality Review...")
                print(f"           Conducting multi-dimensional assessment...")
                ...
                if review_report['needs_revision']:
                    ...
                    print(f"           ✅ Content revised to PhD standards\n")
                else:
                    print(f"           ✅ Content meets PhD quality standards\n")
            else:
                print(f"[Step 2/6] ⚠️  PhD review skipped (disabled or unavailable)\n")
            
            # Phase 3: Add images if requested
            images = []
            if include_images:
                print(f"[Step 3/6] 🖼️  Adding images...")
                ...
                print(f"[Step 3/6] ⚠️  No images requested\n")
            
            # Phase 4: Add tables if requested
            tables = []
            if include_tables:
                print(f"[Step 4/6] 📊 Adding data tables...")
            ...
            if self.document_formatter and output_format in ["docx", "pdf"]:
                ...
                print(f"           ✅ Document professionally formatted\n")
            else:
                # Phase 5: Standard file writing
                print(f"[Step 5/6] 💾 Writing to file...")
                ...
                try:
                    ...
                    print(f"\n❌ FAILED: Could not write file - {e}")
                    return {"success": False, "error": str(e), "file_path": file_path}
            
            # Phase 6: Quality verification summary
            print(f"[Step 6/6] 📊 Final quality verification...")
            ...
            # CRITICAL: Track last generated document for reference!
...
| Metric 4 | 300   | Fourth data point |"""
    ...
    def chat(self, message: str, conversation_history: List[Dict[str, str]]) -> str:
        """
        Chat with the AI system using configured LLM providers with memory.
        ...
        try:
            ...
            messages = [
                {"role": "system", "content": "You are Graive AI, an autonomous general intelligence system with reflection-based validation, multi-provider routing, and comprehensive document generation capabilities. You can generate essays, research papers, and documents with images and tables. When users ask you to write something, confirm the details and let them know you're working on it. Be helpful, remember context, and be professional."}
            ]
            ...
            if gemini_key:
                ...
                # Build context from history for Gemini
            ...
            return "No LLM providers available. Please configure API keys in .env file."
    ...
    def process_user_request(self, message: str, user_name: str = None) -> Dict[str, Any]:
        ...
        if self.request_reasoner:
            ...
            return {'action': 'chat', 'message': message, 'analysis': analysis}
